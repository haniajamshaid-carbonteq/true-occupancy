/* global React, TableSkeleton, Pagination */
...
function DataTable<T>({
  ...
  const visibleRows = pageSize
    ...
    : rows;
  // Range / page-count text lives in the Pagination primitive — it derives
  // firstIdx / lastIdx / totalPages from page + pageSize + total itself.
